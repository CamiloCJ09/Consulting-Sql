...
select guestName, guestAddress from Guest where guestAddress == "Cali" order by guestName;
select * from Room where (type == "Family" or type == "Double") and (price < 80) order by price asc;
